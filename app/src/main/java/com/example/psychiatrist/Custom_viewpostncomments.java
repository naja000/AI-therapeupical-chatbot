...
public class Custom_viewpostncomments extends BaseAdapter {
...
//    ArrayList<String> g;
    ...
    public Custom_viewpostncomments(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c) {
...
//        this.g=g;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_viewpostncomments, null);
