...
public class Custom_viewschedule extends BaseAdapter {
...
//    ArrayList<String> g;
    ...
    public Custom_viewschedule(Context applicationContext, ArrayList<String> a, ArrayList<String> c, ArrayList<String> d, ArrayList<String> e) {
...
//        this.g=g;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_viewschedule, null);
