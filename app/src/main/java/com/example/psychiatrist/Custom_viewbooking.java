...
public class Custom_viewbooking extends BaseAdapter {
...
//    ArrayList<String> b;
    ...
    public Custom_viewbooking(Context applicationContext, ArrayList<String> a, ArrayList<String> c, ArrayList<String> d, ArrayList<String> e, ArrayList<String> f, ArrayList<String> g) {
...
//        this.b=b;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_viewbooking, null);
...
//        ImageView i1=(ImageView) gridView.findViewById(R.id.imgaprtmnt);
        ...
        TextView tv4=(TextView)gridView.findViewById(R.id.fromtime);
        TextView tv5=(TextView)gridView.findViewById(R.id.totime);
        TextView tv6=(TextView)gridView.findViewById(R.id.tvbalcony);
